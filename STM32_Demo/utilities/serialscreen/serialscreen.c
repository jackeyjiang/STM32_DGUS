...
void SyncMealNameDisp(uint8_t meal_id,uint8_t floor)							
{
	...
	{
		case 0x00:break;
		case 0x01:mystrcat(temp,mealname_1st,strcspn((char*)mealname_1st,p_t));break;		
		case 0x02:mystrcat(temp,mealname_2nd,strcspn((char*)mealname_2nd,p_t));break;		
		case 0x03:mystrcat(temp,mealname_3rd,strcspn((char*)mealname_3rd,p_t));break;	
		case 0x04:mystrcat(temp,mealname_4th,strcspn((char*)mealname_4th,p_t));break;	   
		default:break;			
	}
	Uart3_Sent(temp,sizeof(temp));	
}
...
void ChangeVariableValues(int16_t VariableAdress,uint8_t *VariableData,uint8_t length)
{
	uint8_t i= 0,j=0;
