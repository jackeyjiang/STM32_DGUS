...
void  SPRT(void)
{
  unsigned char   SendStc[3]={0x1d,0x56,0x01};		//切纸命令
	...
	unsigned char  p2[]={"秘制猪手饭  1\t15\t015\r\n"};
	unsigned char  p3[]={"潮氏卤鸡腿饭1\t15\t015\r\n"};
	unsigned char  p4[]={"特色稻香肉饭1\t15\t015\r\n"};
	unsigned char  p5[]={"黑椒猪扒饭  1\t15\t015\r\n"};
  unsigned char  p6[]={"蒲烧鲷鱼饭  1\t15\t015\r\n"};
  unsigned char  p7[]={"蒲烧秋刀鱼饭1\t15\t015\r\n"};
