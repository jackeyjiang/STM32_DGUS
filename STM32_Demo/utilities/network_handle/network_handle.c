...
unsigned char  TID[7] = {0xa2,0x00,0x04,0x10,0x00,0x00,0x30}; /*终端TID码：可修改*/
...
const Meal_struction Meal[MealKindTotoal]={
                   ...
                   0x00,0x00,	 0x10,0x00,0x00,0x51,  {"香菇滑鸡饭      "},   0x00,0x00,0x00,0x00,0x15,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x52,  {"红焖牛肉饭      "},   0x00,0x00,0x00,0x00,0x15,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x53,  {"土豆焖鸭饭      "},   0x00,0x00,0x00,0x00,0x15,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x54,  {"香辣排骨饭      "},   0x00,0x00,0x00,0x00,0x15,0x00, 	{"C001"},
                   ...
                   0x00,0x00,	 0x10,0x00,0x00,0x57,  {"蔬食香肠饭      "},   0x00,0x00,0x00,0x00,0x12,0x00, 	{"C001"},
						   };
...
const uint8_t  Discount =1;  //定义折扣10折(不打折),5折(半价),0折(不要钱)
...
const char price_11th= 15*Discount/10;
const char price_12th= 15*Discount/10;
const char price_13th= 15*Discount/10;
const char price_14th= 15*Discount/10;
const char price_15th= 15*Discount/10;
const char price_16th= 15*Discount/10;
const char price_17th= 12*Discount/10;
/*屏幕显示的餐品名称*/
...
const uint8_t sell_type_5th[4]={0x0B,0x0C,0x0D,0x0E}; //第五个售餐菜单
