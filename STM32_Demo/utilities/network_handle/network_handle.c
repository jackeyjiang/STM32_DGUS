...
unsigned char  TID[7] = {0xa2,0x00,0x04,0x10,0x00,0x00,0x38}; /*终端TID码：可修改*/
...
const Meal_struction Meal[MealKindTotoal]={
                   ...
                   0x00,0x00,	 0x10,0x00,0x00,0x54,  {"白灼虾饭        "},   0x00,0x00,0x00,0x00,0x15,0x00, 	{"C001"},
...
const char    mealname_14th[10]= {"白灼虾饭"};
