...
const Meal_struction Meal[MealKindTotoal]={
                   ...
                   0x00,0x00,	 0x10,0x00,0x00,0x51,  {"红烧排骨套餐    "},   0x00,0x00,0x00,0x00,0x40,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x52,  {"红焖牛肉饭      "},   0x00,0x00,0x00,0x00,0x10,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x53,  {"土豆焖鸡饭      "},   0x00,0x00,0x00,0x00,0x10,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x54,  {"香辣排骨饭      "},   0x00,0x00,0x00,0x00,0x10,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x55,  {"五香卤水鸭套餐  "},   0x00,0x00,0x00,0x00,0x40,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x56,  {"辣子鸡套餐      "},   0x00,0x00,0x00,0x00,0x40,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x57,  {"糖醋龙利鱼饭    "},   0x00,0x00,0x00,0x00,0x40,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x58,  {"干豆角烧肉饭    "},   0x00,0x00,0x00,0x00,0x12,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x59,  {"豆汁鸡块饭      "},   0x00,0x00,0x00,0x00,0x12,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x60,  {"飘香肉饼饭      "},   0x00,0x00,0x00,0x00,0x12,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x61,  {"鱼香肉丝饭      "},   0x00,0x00,0x00,0x00,0x12,0x00, 	{"C001"},
                   0x00,0x00,	 0x10,0x00,0x00,0x62,  {"糖醋龙力鱼饭    "},   0x00,0x00,0x00,0x00,0x12,0x00, 	{"C001"},
...
const char price_11th= 40*Discount/10;
const char price_12th= 10*Discount/10;
const char price_13th= 10*Discount/10;
const char price_14th= 10*Discount/10;
const char price_15th= 40*Discount/10;
const char price_16th= 40*Discount/10;
const char price_17th= 40*Discount/10;
const char price_18th= 12*Discount/10;
const char price_19th= 12*Discount/10;
const char price_20th= 12*Discount/10;
const char price_21th= 12*Discount/10;
const char price_22th= 12*Discount/10;
...
const char    mealname_11th[14]= {"红烧排骨套餐"};
const char    mealname_12th[12]= {"红焖牛肉饭"};
const char    mealname_13th[12]= {"土豆焖鸡饭"};
const char    mealname_14th[12]= {"香辣排骨饭"};
const char    mealname_15th[16]= {"五香卤水鸭套餐"};
const char    mealname_16th[12]= {"辣子鸡套餐"};
const char    mealname_17th[14]= {"糖醋龙利鱼饭"};
const char    mealname_18th[14]= {"干豆角烧肉饭"};
const char    mealname_19th[12]= {"豆汁鸡块饭"};
const char    mealname_20th[12]= {"飘香肉饼饭"};
const char    mealname_21th[12]= {"鱼香肉丝饭"};
const char    mealname_22th[14]= {"糖醋龙力鱼饭"};
...
const uint8_t sell_type_3rd[4]={0x0D,0x02,0x05,0x08}; //第三个售餐菜单
